 ...
 */
export const samplePredictions: AIPredictedField[] = [
  {
 ...
 */
export const sampleCorrections: UserCorrection[] = [
  {
    originalPrediction: {
      fieldId: '5b6c7d8e-9f0a-1b2c-3d4e-5f6a7b8c9d0e',
      label: 'Contract Amount',
 ...
 */
export function enhanceMetadataWithAIData(metadata: any): any {
  return {
    ...metadata,
